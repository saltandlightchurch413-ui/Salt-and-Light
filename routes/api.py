...
def get_songs():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'songs': [], 'total': 0, 'page': 1, 'pages': 0, 'error': str(e)}), 200
...
def recent_songs():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'songs': [], 'error': str(e)}), 200
...
def index_letters():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'english': [], 'telugu': [], 'error': str(e)}), 200
...
def get_gallery():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'images': [], 'total': 0, 'page': 1, 'pages': 0, 'error': str(e)}), 200
...
def get_about():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'about': {'title': '', 'content': '', 'logo_url': '', 'error': str(e)}}), 200
